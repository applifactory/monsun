...
datepickr.init = function (element, instanceConfig) {
    ...
    buildWeekdays = function () {
        var weekdayContainer = document.createElement('thead'),
            ...
            weekdays = self.l10n.weekdays.shorthand.slice(0);
    ...
    buildMonthNavigation = function () {
        ...
        monthNavigation  = '<span class="datepickr-prev-month"><i class="icon-left-dir"></i></span>';
        monthNavigation += '<span class="datepickr-next-month"><i class="icon-right-dir"></i></span>';
    ...
    calendarClick = function (event) {
        ...
        if (targetClass) {
            if (targetClass === 'datepickr-prev-month' || targetClass === 'datepickr-next-month' || targetClass === 'icon-left-dir' || targetClass === 'icon-right-dir' ) {
                if (targetClass === 'datepickr-prev-month' || targetClass === 'icon-left-dir') {
